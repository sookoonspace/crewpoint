...
/// V1 cross-event Chat tab — empty-state-only. Real aggregation is
/// scoped to a future PR; this tab just funnels users back to the
/// Dashboard.
class ChatTabPlaceholderScreen extends StatelessWidget {
  const ChatTabPlaceholderScreen({super.key, this.onOpenDashboard});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: EmptyStatePlaceholder(
        title: s.chat.tabEmptyTitle,
        subtitle: s.chat.tabEmptySubtitle,
