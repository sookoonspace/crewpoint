...
void main() {
  testWidgets(
    'renders BudgetStrings.tabEmptyTitle + CTA; tap fires onOpenDashboard seam',
    (tester) async {
      var taps = 0;

      await tester.pumpWidget(
        MaterialApp(
          home: BudgetTabPlaceholderScreen(onOpenDashboard: () => taps++),
        ),
      );
      await _pumpFrames(tester);

      expect(find.text('Budget is coming soon'), findsOneWidget);
