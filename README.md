...
> **Placeholder section.** Screenshots will be generated by golden-style
> tests under `test/screenshots/` and committed to `screenshots/` in
> Phase 6 of the web-admin-reporting plan. Until product produces final
> captures, the images carry a "PLACEHOLDER — replace before public
> launch" overlay so they cannot accidentally ship as marketing
> material.

<!-- Screenshots are produced by `scripts/regenerate-screenshots.sh`
     once Phase 6 ships:
